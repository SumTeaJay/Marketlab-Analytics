...
from app.validation import validate_values, validate_sw, validate_market_parameters, validate_market_id, check_monopoly_and_pc, validate_market_quantity, check_monopoly_equality, check_pc_equality